        ...
        <CardContent className="grid p-0 md:grid-cols-2 min-h-[420px]">
          ...
          <form className="p-6 md:p-8" onSubmit={onSubmit}>
            <div className="flex flex-col gap-6">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground text-balance">
                  Join in the buzz. Get a piece of the action!
                </p>
              </div>
            ...
            <div className="mt-5 text-center">
              <Link href="/workspace/create" className="text-sm font-light text-[#6b840a] dark:text-[#caef35]/80 text-center underline underline-offset-2">Create a workspace</Link>
            </div>
          </form>
        </CardContent>
      </Card>
