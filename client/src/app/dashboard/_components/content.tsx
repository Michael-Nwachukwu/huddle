	...
	return (
		<div>
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
				...
				<div className="bg-white dark:bg-[#0e0e10] rounded-xl p-4 sm:p-6 flex flex-col items-start justify-start border border-gray-200 dark:border-[#1F1F23] w-full col-span-1 lg:col-span-2">
				...
				<div className="bg-white dark:bg-[#0e0e10] rounded-xl p-4 sm:p-6 flex flex-col border border-gray-200 dark:border-[#1F1F23] w-full">
