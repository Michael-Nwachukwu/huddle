...
import { formatHederaTokenAmount } from "@/lib/utils";
...
export const WorkspaceProvider: React.FC<WorkspaceProviderProps> = ({ children }) => {
	...
	const {
		...
		contract,
		method: "function getUserWorkspaces(address) view returns ((uint256 workspaceId, string name)[])",
	...
	const formattedUserWorkspaces = rawUserWorkspaces?.map((workspace: UserWorkspace) => ({
	...
	const activeWorkspace: WorkspaceData | null = rawActiveWorkspace
		? {
				...
				nativeBalance: formatHederaTokenAmount(rawActiveWorkspace[2]),
				ercRewardAmountSum: formatHederaTokenAmount(rawActiveWorkspace[3]), // rawActiveWorkspace[3].toString(),
